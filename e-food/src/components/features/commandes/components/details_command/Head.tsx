...
export default function HeadDetails({ setShow, total, l }: { setShow: any, total: number, l: React.MutableRefObject<LivraisonPropsType | undefined> }) {
    ...
    >
      ...
      >
        ...
        >
          ...
          {l.current?.description != undefined ? <div
