export default function HeadDetails({setShow}:{setShow:any}){
  ...
  >
    ...
    >
      <div
        role="button"
        tabIndex={0}
        className="notion-topbar-share-menu"
        style={{
          userSelect: "none",
          transition: "background 20ms ease-in 0s",
          cursor: "pointer",
      ...
      <div
        role="button"
        tabIndex={0}
        className="notion-topbar-updates-button"
        aria-label="Dernières modifications"
        style={{
          userSelect: "none",
          transition: "background 20ms ease-in 0s",
          cursor: "pointer",
